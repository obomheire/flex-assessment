  ...
  const properties = [
    {
      ...
      description:
        "Modern 2-bedroom apartment in the heart of Shoreditch with stunning city views. Perfect for professionals and digital nomads.",
      imageUrl:
    ...
    },
    {
      ...
      description:
        "Stylish studio in Berlin's most vibrant neighborhood. Walking distance to museums, cafes, and public transport.",
      imageUrl:
    ...
    },
    {
      ...
      description:
        "Charming loft in the historic Marais district. High ceilings, exposed beams, and Parisian charm.",
      imageUrl:
    ...
    },
    {
      ...
      description:
        "Spacious 2-bedroom near Camden Market. Ideal for creative professionals and music lovers.",
      imageUrl:
    ...
    },
    {
      ...
      description:
        "Luxury penthouse with panoramic views of Berlin. Modern design meets industrial chic.",
      imageUrl:
    ...
    },
    {
      ...
      description:
        "Intimate studio in the literary heart of Paris. Perfect for solo travelers and writers.",
      imageUrl:
  ...
  for (let i = 0; i < 50; i++) {
    ...
    const categories = {
      cleanliness: Math.min(
        10,
        Math.max(1, Math.round(rating + cleanlinessVariation))
      ),
      communication: Math.min(
        10,
        Math.max(1, Math.round(rating + communicationVariation))
      ),
      respect_house_rules: Math.min(
        10,
        Math.max(1, Math.round(rating + rulesVariation))
      ),
      value: Math.min(10, Math.max(1, Math.round(rating))),
      location: Math.min(
        10,
        Math.max(1, Math.round(rating + (Math.random() - 0.3)))
      ),
    };
    ...
    const reviewText =
      reviewTemplates[reviewCategory as keyof typeof reviewTemplates][
        Math.floor(
          Math.random() *
            reviewTemplates[reviewCategory as keyof typeof reviewTemplates]
              .length
